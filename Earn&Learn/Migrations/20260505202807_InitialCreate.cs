        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    sadrzaj = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    datumSlanja = table.Column<DateTime>(type: "datetime(6)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    idTutora = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    idStudenta = table.Column<int>(type: "int", nullable: false),
                    idTutora = table.Column<int>(type: "int", nullable: false),
                    datumIVrijeme = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    tipInstrukcija = table.Column<int>(type: "int", nullable: false),
                    status = table.Column<int>(type: "int", nullable: false),
                    qrKod = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    idStudenta = table.Column<int>(type: "int", nullable: false),
                    idTutora = table.Column<int>(type: "int", nullable: false),
                    iznos = table.Column<double>(type: "double", nullable: false),
                    datumUplate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
